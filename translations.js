...
async function loadTranslations() {
  try {
    // Check if CONFIG exists and has SCRIPT_URL
    if (!window.CONFIG || !window.CONFIG.SCRIPT_URL || window.CONFIG.SCRIPT_URL.includes('YOUR_GOOGLE')) {
      console.warn('⚠️ Using fallback translations (SCRIPT_URL not configured)');
